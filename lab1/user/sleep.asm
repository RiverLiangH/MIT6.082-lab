...
int main(int argc,char *argv[]){
  ...
  3c:	7d850513          	addi	a0,a0,2008 # 810 <malloc+0x108>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	48a50513          	addi	a0,a0,1162 # 840 <digits>
 3be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 486:	3beb8b93          	addi	s7,s7,958 # 840 <digits>
 ...
 5c6:	27690913          	addi	s2,s2,630 # 838 <malloc+0x130>
        while(*s != 0){
...
free(void *ap)
{
 ...
 68e:	1ce7b783          	ld	a5,462(a5) # 858 <freep>
 ...
 6bc:	00e6ea63          	bltu	a3,a4,6d0 <free+0x50>
{
 ...
 6fe:	14f73f23          	sd	a5,350(a4) # 858 <freep>
}
 702:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 730:	12c53503          	ld	a0,300(a0) # 858 <freep>
 ...
 758:	10490913          	addi	s2,s2,260 # 858 <freep>
  if(p == (char*)-1)
 75c:	5afd                	li	s5,-1
 75e:	a88d                	j	7d0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 760:	00000797          	auipc	a5,0x0
 764:	10078793          	addi	a5,a5,256 # 860 <base>
 768:	00000717          	auipc	a4,0x0
 76c:	0ef73823          	sd	a5,240(a4) # 858 <freep>
 770:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 792:	0ca73523          	sd	a0,202(a4) # 858 <freep>
      return (void*)(p + 1);
