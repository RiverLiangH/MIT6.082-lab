...
extern char etext[];//lab3 kernel pt


//lab3 new func
void proc_free_kernel_pagetable(struct proc *p);

//void proc_free_kernel_pagetable(uint64 kstack, pagetable_t pagetable);
...
found:
  ...
  //lab3-2
  //create a page table, meanwhile allocate a kernel stack
